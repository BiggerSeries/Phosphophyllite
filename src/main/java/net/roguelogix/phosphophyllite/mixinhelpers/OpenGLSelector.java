...
public class OpenGLSelector {
    ...
    private static final Logger LOGGER = LogManager.getLogger("Phosphophyllite/OpenGLSelector");
...
//        }
        ...
        LOGGER.error("Phosphophyllite OpenGL version search enabled, this may potentially cause issues with some graphics cards, please report issues");
...
//        LOGGER.error("this can be disabled in phosphophyllite-client config if it is causing issues for you");
        ...
        int allowedVersions = Integer.parseInt(System.getProperty("phosphophyllite.glversions", "0000"));
